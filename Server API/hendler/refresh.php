<?php
// refresh.php - Handles API refresh token requests
...
if (!$user_id || !$device_id || !$session_token || !$refresh_token) {
...
// Forward refresh request to auth server
$auth_response = auth_server_refresh($user_id, $session_token, $refresh_token);
